...
export async function POST(request: Request) {
  ...
  const row = {
    ...
    instagram_media_count: input.instagram_media_count ?? null,
    instagram_name: emptyToNull(input.instagram_name),
    instagram_biography: emptyToNull(input.instagram_biography),
    instagram_suggested_quality: input.instagram_suggested_quality ?? null,
